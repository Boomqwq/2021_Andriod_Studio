...
public class MainActivity extends AppCompatActivity {
    ...
    private void getData(String studentId){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (studentId==null)
                {
                    messages = baseGetMessageFromRemote("",Constants.token);
                }
                else
                {
    ...
    public List<Message> baseGetMessageFromRemote(String student_id, String token){
        String urlStr = Constants.BASE_URL+String.format("messages?student_id=%s",student_id);
...
//                Log.d(TAG, "baseGetMessageFromRemoteReader: "+reader.readLine());
                result = new Gson().fromJson(reader, MessageListResponse.class);
                Log.d(TAG, "baseGetMessageFromRemote: "+result.feeds);
                reader.close();
                in.close();
